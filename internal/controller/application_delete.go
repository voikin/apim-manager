...
func (c *Controller) DeleteApplication(
	ctx context.Context,
	req *managerpb.DeleteApplicationRequest,
) (*managerpb.DeleteApplicationResponse, error) {
	_, err := c.profileStoreClient.DeleteApplication(ctx, &profilestorepb.DeleteApplicationRequest{
		Id: req.GetId(),
	})
	if err != nil {
	...
	return &managerpb.DeleteApplicationResponse{}, nil
}
